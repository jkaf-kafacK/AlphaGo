...
class Board:
    ...
    def resulting_state(self, fcoords):
        res_board = copy.deepcopy(self)
        player = self.next_player() # TODO: initial color is black wa9ila gotta check this
        res_board.play_move(fcoords)
        return res_board
    ...
    def current_player(self): # walid made this
        return Board.flip(self._nextPlayer)
    ...
    def last_move(self): # walid made this
        if self._historyMoveNames:
            move = self._historyMoveNames.pop()
